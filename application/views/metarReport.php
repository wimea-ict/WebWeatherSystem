...
?>
    <aside class="right-side">
        ...
        <section class="content report">
            ...
            <div class="no-print">
                <div class="row">
                    <form action="<?php echo base_url(); ?>index.php/MetarReport/displaymetarreport/" method="post" enctype="multipart/form-data">
                        <?php  if($userrole=='OC'){?>
                            <div class="col-xs-3">
            ...
            if(is_array($displayMetarReportHeaderFields) &&
              ...
              is_array($metarreportdataforADay) &&
                  !empty($metarreportdataforADay)
            ){
                ...
                <table class="report-table" id="table2excel">
                    ...
                    $count = 0;
                        ...
                        foreach($metarreportdataforADay as $metardata){
                            $count++;
