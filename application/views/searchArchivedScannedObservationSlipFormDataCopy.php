                    ...
                    $count = 0;
                     foreach($archivedscannedobservationslipformdatacopyforADay as $data){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>/index.php/SearchArchivedScannedObservationSlipFormDataCopy/DownloadArchivedScannedObservationSlipForm/<?php echo $data->FileName; ?>">Download  Image</a>
