...
?>
    ...
    <div class="no-print">
        <div class="row">
            <form action="<?php echo base_url(); ?>index.php/DekadalReport/displaydekadalreport/" method="post" enctype="multipart/form-data">
                <?php  if($userrole=='OC'){?>
                    <div class="col-xs-3">
        ...
        if (is_array($DekadalReportDataFromobservationslipTableforAGivenRangeInAMonthAndTime0600Z) ||
            ...
            foreach($finalarraymerge as $data){ ?>
                ...
                <tr>
                    ...
                    <?php
                    if($data['DekadalTime0600Z_Rainfall']=='' ) {
                        ?>
                        <td class="main"></td>

                    <?php
                    }else if($data['DekadalTime0600Z_Rainfall'] < 0.1){
                        ?>
                    ...
                    <?php
                    }else if($data['DekadalTime0600Z_Rainfall']=='NIL' ) {
                        ?>
                        <td class="main"><?php echo 'NIL';?></td>

                    <?php
                    }elseif($data['DekadalTime0600Z_Rainfall']=='TR' ) {
                        ?>
                        <td class="main"><?php echo 'TR';?></td>
